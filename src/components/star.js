...
export default function Galaxy({
  ...
  // IntersectionObserver to only initialize WebGL when component is visible
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Failed to create WebGL renderer for Galaxy:', error);
      return;
    }
    ...
    return () => {
      ...
      try {
        ...
        // Ignore errors when losing context
      }
    };
  }, [
    isVisible,
